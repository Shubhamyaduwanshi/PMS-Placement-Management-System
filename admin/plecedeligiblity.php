...
<?php include("header.php"); ?>
 	...
 	<!----><h2>Create Eligible Students List</h2>
      ...
      <form method="post" action="showeligiblep.php" enctype="multipart/form-data">
         	<div class="vali-form">
             <div class="col-md-6 form-group2">
              <label class="control-label">Company name</label>
              <?php
             include("connect.php");
             $sql ="SELECT DISTINCT company_name FROM add_placement";
          ...
          <?php 
             ...
             <div class="col-md-6 form-group2">
              ...
              <?php
             include("connect.php");
             $sql ="SELECT DISTINCT company_type FROM add_placement";
                   $result = mysql_query($sql); ?>
