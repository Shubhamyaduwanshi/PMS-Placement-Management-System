        ...
        <form method="post" action="updateuser.php" enctype="multipart/form-data">
            ...
            <div class="col-md-6 form-group1">
              <label class="control-label">Phone Number</label>
                    <input type="text" placeholder="Phone Number" name="phone" value="<?php echo $uphone; ?>" ma required>
      </div>
            ...
            <div class="col-md-12 form-group">
              <button type="submit" class="btn btn-primary" name="updateu">Update</button>
