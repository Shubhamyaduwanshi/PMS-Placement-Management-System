							...
							<div class="item">
								<div class="owl-slider-item">
									...
									<div class="intro-text">
										<div class="intro-lead-in">We are Providing the number one</div>
										<div class="intro-heading">Psychometric Analysis & Carrier Guidence</div>
									</div>
								</div>
							</div>
							<div class="item">
		...
		<section class="section-cta">
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="section-title">
							<p>It is vital to remember that a student’s actual abilities are as important as their aptitude for a certain stream or subject. A <b>psychometric test</b>is a scientific method to check existing skills and interests and assess personality. It helps a student to make an informed decision about their future study course.<br>
                            A student undergoes many stressful changes during their student life and there are different stages where they can utilize a <b>psychometric test</b> to make better decisions for future. There is no failing or passing in these tests. Also, results may be unique as every candidate is different.. One can take the <b>online career assessment</b> even in 11th and 12th standard or even before choosing stream for graduation. One may  take a career assessment under following situations :
			</p>
						</div>
					</div>
				</div>
